...
void fetch()
{
    ...
    t_paquete *paquete = __crear_super_paquete(PETICION_DE_INSTRUCCIONES_CPU_MEMORIA);
    __cargar_int_al_super_paquete(paquete, un_contexto->pID);
    __cargar_uint32_al_super_paquete(paquete, un_contexto->r_cpu->PC);
...
uint32_t solicitar_uint32_memoria(int dir_logica)
{
    ...
    {
        t_paquete *paqueteLecturaMemoria = __crear_super_paquete(LECTURA_BLOQUE_CPU_MEMORIA);
        __cargar_int_al_super_paquete(paqueteLecturaMemoria, un_contexto->pID);
        __cargar_int_al_super_paquete(paqueteLecturaMemoria, dir_fisica);
        __cargar_size_t_al_super_paquete(paqueteLecturaMemoria, tam);
        __cargar_int_al_super_paquete(paqueteLecturaMemoria, T_UINT32);
...
uint8_t solicitar_uint8_memoria(int dir_logica)
{
    ...
    else
    {
        ...
        __cargar_int_al_super_paquete(paqueteLecturaMemoria, dir_fisica);
        __cargar_size_t_al_super_paquete(paqueteLecturaMemoria, tam);
        __cargar_int_al_super_paquete(paqueteLecturaMemoria, T_UINT8);
  ...
  //  while(cant_pags!=0){
    int dir_fisica = MMU(aux);
        ...
        else
        {
            ...
            __cargar_int_al_super_paquete(paqueteLecturaMemoria, dir_fisica);
            __cargar_size_t_al_super_paquete(paqueteLecturaMemoria, tam);
            __cargar_int_al_super_paquete(paqueteLecturaMemoria, T_STRING);
...
int escribir_valor_memoria_uint8(uint32_t dir_logica, uint8_t valorAEscribir)
{
    ...
    if (dir_fisica != -1)
    {
        ...
        t_paquete *paqueteEscrituraMemoria = __crear_super_paquete(ESCRITURA_BLOQUE_CPU_MEMORIA);

        __cargar_int_al_super_paquete(paqueteEscrituraMemoria, un_contexto->pID);
        __cargar_int_al_super_paquete(paqueteEscrituraMemoria, dir_fisica);
        __cargar_size_t_al_super_paquete(paqueteEscrituraMemoria, tam);
        __cargar_int_al_super_paquete(paqueteEscrituraMemoria, T_UINT8);
        __cargar_choclo_al_super_paquete(paqueteEscrituraMemoria, &valorAEscribir, tam);
...
int escribir_valor_memoria_uint32(uint32_t dir_logica, uint32_t valorAEscribir)
{
    ...
    if (dir_fisica != -1)
    {
        ...
        __cargar_int_al_super_paquete(paqueteEscrituraMemoria, dir_fisica);
        __cargar_size_t_al_super_paquete(paqueteEscrituraMemoria, tam);
        __cargar_int_al_super_paquete(paqueteEscrituraMemoria, T_UINT32);
        __cargar_choclo_al_super_paquete(paqueteEscrituraMemoria,  &valorAEscribir, tam);
...
int escribir_valor_memoria_string(uint32_t dir_logica, char* valorAEscribir)
{
    ...
    if (dir_fisica != -1)
    {
        ...
        __cargar_int_al_super_paquete(paqueteEscrituraMemoria, dir_fisica);
        __cargar_size_t_al_super_paquete(paqueteEscrituraMemoria, tam);
        __cargar_int_al_super_paquete(paqueteEscrituraMemoria, T_STRING);
        __cargar_choclo_al_super_paquete(paqueteEscrituraMemoria, (void*) valorAEscribir, tam);
...
void execute()
{
    ...
    switch (nombre_instruccion_enum)
    {
        ...
        case IO_GEN_SLEEP:
            ...
            paquete = __crear_super_paquete(ATENDER_INSTRUCCION_CPU);

            agregar_contexto_a_paquete(paquete);

            __cargar_string_al_super_paquete(paquete, instruccion_split[0]); // NOMBRE INSTRUCCION
            __cargar_int_al_super_paquete(paquete, 2); 

            // PARAMETROS

            __cargar_int_al_super_paquete(paquete, T_STRING);
            __cargar_string_al_super_paquete(paquete, instruccion_split[1]); // NOMBRE INTERFAZ

            __cargar_int_al_super_paquete(paquete, T_INT);
            __cargar_int_al_super_paquete(paquete, atoi(instruccion_split[2])); 
        ...
        case RESIZE:
            ...
            paquete = __crear_super_paquete(RESIZE_CPU_MEMORIA);

            __cargar_int_al_super_paquete(paquete, un_contexto->pID); 
            __cargar_int_al_super_paquete(paquete, t); 
        ...
        case WAIT:
            ...
            __cargar_int_al_super_paquete(paquete, cantidadParametros); 

            __cargar_int_al_super_paquete(paquete, T_STRING);
            __cargar_string_al_super_paquete(paquete, instruccion_split[1]); // NOMBRE RECURSO
        ...
        case IO_STDIN_READ:
            ...
            __cargar_int_al_super_paquete(paquete, T_SIZE_T);
        ...
        case IO_STDOUT_WRITE:
            ...
            __cargar_string_al_super_paquete(paquete, instruccion_split[0]);
            cantidadParametros = 3;
            __cargar_int_al_super_paquete(paquete, cantidadParametros);
        ...
        case IO_FS_CREATE:
            ...
            __cargar_int_al_super_paquete(paquete, T_STRING);
            __cargar_string_al_super_paquete(paquete, instruccion_split[2]); // NOMBRE ARCHIVO
        ...
        case IO_FS_TRUNCATE:
            ...
            __cargar_int_al_super_paquete(paquete, T_SIZE_T);
            __cargar_size_t_al_super_paquete(paquete, tamanio); // TAMAÑO
        ...
        case IO_FS_WRITE:
            ...
            __cargar_int_al_super_paquete(paquete, T_INT);
            __cargar_int_al_super_paquete(paquete, puntero); //PUNTERO
