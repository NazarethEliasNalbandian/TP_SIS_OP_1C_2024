...
void enviar_contexto_a_kernel_con_desalojo_cpu(){
    desalojar=true;
    t_paquete* un_paquete = __crear_super_paquete(tipo_desalojo);
...
void agregar_contexto_a_paquete(t_paquete * un_paquete){
	...
	__cargar_int_al_super_paquete(un_paquete, un_contexto->pID);
	__cargar_int_al_super_paquete(un_paquete, un_contexto->verificador);
